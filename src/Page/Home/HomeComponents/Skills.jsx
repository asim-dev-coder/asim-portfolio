    ...
    <div>
      <div className="bg-gradient-to-l from-purple-50 to-sky-50">
        <div className="w-9/12 mx-auto py-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 justify-between text-[#023e8a] py-3 gap-4">
            {filteredProducts.map((product) => (
              <div class="relative">
                ...
                <div class="h-[8em] w-[15em] bg-white m-auto rounded-[1em] overflow-hidden relative group p-2 z-0">
