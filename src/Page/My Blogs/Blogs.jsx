...
const Blogs = ({ selectedCategory, increment, handleCartProduct }) => {
    ...
    <div className="lg:w-9/12 w-11/12 mx-auto py-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
        {filteredProducts.map((product) => (
          <div
            key={product.id}
            className="rounded-2xl bg-white shadow-lg border border-white hover:border-teal-300 hover:border"
          >
