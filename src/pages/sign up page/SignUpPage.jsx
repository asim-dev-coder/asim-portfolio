        ...
        >
          <div class="max-w-md mx-auto">
            ...
            <div class="mt-5">
              ...
              <div class="mt-3">
                <button
                  class="py-2 px-4 bg-rose-500 hover:bg-rose-600 focus:ring-rose-400 focus:ring-offset-blue-200 text-white w-full transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2 rounded-lg"
                  type="submit"
                >
                  সাইনআপ করুন
                </button>
